...
<title>Disclaimer & Refund Policy — SAM Visa Services</title>
...
<style>
    ...
    *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
    ...
    /* PAGE HERO — blue/navy for disclaimer */
    ...
    .nb-icon{font-size:18px;flex-shrink:0;}
    ...
    .toc-divider{height:1px;background:var(--gray-border);margin:6px 16px;}
    .toc-section-label{padding:10px 20px 4px;font-size:9px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:var(--gray-light);}
    ...
    /* PAGE DIVIDER BETWEEN DISCLAIMER AND REFUND */
    .policy-divider{display:flex;align-items:center;gap:16px;margin:40px 0 32px;}
    .policy-divider::before,.policy-divider::after{content:'';flex:1;height:2px;background:linear-gradient(90deg,transparent,var(--gray-border));}
    .policy-divider::after{background:linear-gradient(90deg,var(--gray-border),transparent);}
    .pd-label{display:flex;align-items:center;gap:10px;background:var(--white);border:1.5px solid var(--gray-border);border-radius:40px;padding:8px 20px;font-size:11px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:var(--gray-mid);white-space:nowrap;}
    ...
    /* Refund sections get a different accent */
    .refund-section::before{background:linear-gradient(90deg,#92400e,#d97706,#fbbf24,#d97706,#92400e)!important;}
    .refund-section:hover{border-color:rgba(217,119,6,.2)!important;}
    ...
    .sec-num.refund{background:linear-gradient(135deg,#d97706,#92400e);}
    .sec-title{font-family:var(--font-d);font-size:22px;font-weight:700;color:var(--blue-dark);}
    .sec-title.refund{color:#92400e;}
    ...
    .li-dot.refund{background:var(--amber);}

    /* Sub-list */
    .sub-list{list-style:none;display:flex;flex-direction:column;gap:6px;margin:8px 0 4px 20px;}
    .sub-list li{display:flex;align-items:flex-start;gap:8px;font-size:13px;color:var(--gray-mid);line-height:1.6;}
    .sub-dot{width:4px;height:4px;border-radius:50%;background:var(--gray-light);flex-shrink:0;margin-top:8px;}
    ...
    /* STATUS TAGS */
    .status-tag{display:inline-flex;align-items:center;gap:5px;padding:3px 10px;border-radius:20px;font-size:11px;font-weight:700;}
    .status-eligible{background:var(--green-bg);color:#15803d;border:1px solid var(--green-border);}
    .status-no{background:var(--red-bg);color:#991b1b;border:1px solid var(--red-border);}

    /* TWO COLUMN LIST */
    .two-col-list{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:14px;}
    .tcl-item{padding:12px 16px;border-radius:10px;font-size:13px;line-height:1.6;display:flex;gap:10px;align-items:flex-start;}
    ...
    @media(max-width:1000px){.content-wrap{grid-template-columns:1fr;}.toc-card{position:static;}.two-col-list{grid-template-columns:1fr;}}
...
<div class="page-hero">
  <div class="ph-inner">
    <div class="hero-badge">⚖️ Legal Policies</div>
    <h1 class="hero-title">Disclaimer &amp; <em>Refund Policy</em></h1>
    <p class="hero-sub">Please read these policies carefully. They outline the limitations of our services, your rights as a client, and our refund and cancellation terms.</p>
    <div class="hero-date">
...
<div class="content-wrap">
  ...
  <aside>
    <div class="toc-card">
      ...
      <ul class="toc-list">
        <div class="toc-section-label">Website Disclaimer</div>
        ...
        <div class="toc-section-label">Refund Policy</div>
        ...
        <li><a href="#r7"><span class="toc-num">7</span>Processing Refunds</a></li>
        <li><a href="#r8"><span class="toc-num">8</span>Chargebacks</a></li>
        <li><a href="#r9"><span class="toc-num">9</span>Contact</a></li>
      </ul>
    </div>
    ...
    <div class="info-card">
      ...
      <ul class="ic-list">
        ...
        <li><div class="ic-dot"></div>Government fees are non-refundable</li>
        <li><div class="ic-dot"></div>Cancel before processing for refund</li>
        <li><div class="ic-dot"></div>Contact us before chargebacks</li>
      </ul>
    </div>
  </aside>
  ...
  <div class="article">
    ...
    <div class="last-updated" style="border-color:#c0d4f5;background:var(--blue-faint);">
      ...
      <span style="color:var(--blue-dark);">This page contains both the Website Disclaimer and Refund Policy for SAM Visa Services. All information on this website is provided in good faith. By using our services, you agree to these terms.</span>
    </div>
    ...
    <div class="legal-section" id="d3">
      ...
      <div class="red-box"><p>🚫 Sam Visa cannot influence or guarantee the decision made by immigration authorities. No refund will be issued on the basis of a visa refusal.</p></div>
    </div>
    ...
    <div class="legal-section" id="d6">
      ...
      <div class="prose">
        ...
        <p>If legal advice is required, you should consult a licensed immigration lawyer or authorized legal professional.</p>
      </div>
    ...
    <!-- DIVIDER between Disclaimer and Refund -->
    ...
    <!-- R1 -->
    <div class="legal-section refund-section" id="r1">
      <div class="sec-num-wrap"><div class="sec-num refund">1</div><h2 class="sec-title refund">Introduction</h2></div>
      <div class="prose">
      ...
      <div class="warning-box"><p>📋 This policy was last updated in June 2025. We recommend reviewing it before each transaction as terms may be updated periodically.</p></div>
    </div>

    <!-- R2 -->
    <div class="legal-section refund-section" id="r2">
      <div class="sec-num-wrap"><div class="sec-num refund">2</div><h2 class="sec-title refund">Service Fees</h2></div>
      <div class="prose"><p>Sam Visa charges service fees for the following, which are <strong>separate from government visa application fees</strong>:</p></div>
      <ul class="legal-list">
        <li><div class="li-dot refund"></div>Visa consultation and guidance</li>
        <li><div class="li-dot refund"></div>Application preparation and form completion</li>
        <li><div class="li-dot refund"></div>Document review and verification</li>
        <li><div class="li-dot refund"></div>Administrative support throughout the process</li>
      </ul>
    </div>

    <!-- R3 -->
    <div class="legal-section refund-section" id="r3">
      <div class="sec-num-wrap"><div class="sec-num refund">3</div><h2 class="sec-title refund">Government Fees</h2></div>
      <div class="prose"><p>Visa fees charged by embassies, consulates, or immigration authorities are <strong>not controlled by Sam Visa</strong>.</p></div>
      <ul class="legal-list">
        <li><div class="li-dot refund"></div>Government and embassy fees are generally <strong>non-refundable</strong></li>
        <li><div class="li-dot refund"></div>Such fees are payable directly to the relevant government authority</li>
      </ul>
      <div class="red-box"><p>🚫 Sam Visa cannot refund government or embassy fees under any circumstances. These fees are outside of our control and are subject to the policies of the respective immigration authority.</p></div>
    </div>

    <!-- R4 -->
    <div class="legal-section refund-section" id="r4">
      <div class="sec-num-wrap"><div class="sec-num refund">4</div><h2 class="sec-title refund">Refund Eligibility</h2></div>
      <div class="prose"><p>Refunds of Sam Visa service fees may be considered under the following conditions:</p></div>
      <div class="two-col-list">
        <div class="tcl-item eligible">
          <span>✅</span>
          <span>Client cancels <strong>before</strong> the visa application process has started</span>
        </div>
        <div class="tcl-item eligible">
          <span>✅</span>
          <span>Payment was made <strong>in error</strong> (e.g. duplicate transaction)</span>
        </div>
        <div class="tcl-item eligible">
          <span>✅</span>
          <span>Services cannot be provided due to <strong>operational issues</strong> from Sam Visa</span>
        </div>
      </div>
    </div>

    <!-- R5 -->
    <div class="legal-section refund-section" id="r5">
      <div class="sec-num-wrap"><div class="sec-num refund">5</div><h2 class="sec-title refund">Non-Refundable Situations</h2></div>
      <div class="prose"><p>Refunds will <strong>not</strong> be granted in the following situations:</p></div>
      <div class="two-col-list">
        <div class="tcl-item no">
          <span>🚫</span>
          <span>Visa application has <strong>already been submitted</strong></span>
        </div>
        <div class="tcl-item no">
          <span>🚫</span>
    ...
    <!-- R6 -->
    <div class="legal-section refund-section" id="r6">
      <div class="sec-num-wrap"><div class="sec-num refund">6</div><h2 class="sec-title refund">Cancellation Policy</h2></div>
      <div class="prose">
        <p>Clients may request cancellation by contacting Sam Visa <strong>before</strong> application processing begins.</p>
        <p>Once the application process has started, cancellation may not be possible and service fees already incurred will not be refunded.</p>
      </div>
      <div class="highlight-box"><p>📞 To request a cancellation, please contact us as early as possible at <strong>info@samvisauk.com</strong> or via WhatsApp before any work has commenced on your application.</p></div>
    </div>

    <!-- R7 -->
    <div class="legal-section refund-section" id="r7">
      <div class="sec-num-wrap"><div class="sec-num refund">7</div><h2 class="sec-title refund">Processing Refunds</h2></div>
      <div class="prose"><p>If a refund is approved by Sam Visa, the following terms apply:</p></div>
      <ul class="legal-list">
        <li><div class="li-dot refund"></div>Refunds will be processed within <strong>7–14 business days</strong> of approval</li>
        <li><div class="li-dot refund"></div>Refunds will be made using the <strong>original payment method</strong></li>
        <li><div class="li-dot refund"></div>Administrative charges may be deducted from the refund amount</li>
      </ul>
    </div>

    <!-- R8 -->
    <div class="legal-section refund-section" id="r8">
      <div class="sec-num-wrap"><div class="sec-num refund">8</div><h2 class="sec-title refund">Chargebacks</h2></div>
      <div class="prose">
        <p>Customers are strongly encouraged to contact Sam Visa directly before initiating any payment disputes or chargebacks with their bank or card provider.</p>
      </div>
      <div class="red-box"><p>🚫 Unjustified chargebacks may result in suspension of services and may be disputed by Sam Visa with supporting documentation of services rendered.</p></div>
    </div>

    <!-- R9 — Contact for Refunds -->
    <div class="contact-card" id="r9">
      <div class="cc-inner">
        <p style="font-size:10px;font-weight:700;letter-spacing:2.5px;color:rgba(255,255,255,.5);text-transform:uppercase;margin-bottom:6px;">Refund Policy — Section 9</p>
        <p class="cc-title">Contact for Refund Requests</p>
        <p class="cc-sub">All refund and cancellation requests must be submitted in writing to the contact details below. Please include your booking reference and reason for the request.</p>
        <div class="cc-links">
    ...
    <div style="background:var(--white);border:1.5px solid var(--gray-border);border-radius:14px;padding:22px 28px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;">
      <div>
        ...
        <p style="font-size:13px;color:var(--gray-mid);">Understand how we collect, store, and protect your personal data.</p>
      </div>
      <a href="/privacy-policy" style="display:inline-flex;align-items:center;gap:8px;background:linear-gradient(135deg,#1a4aab,#0f2f7a);color:#fff;font-family:'Jost',sans-serif;font-weight:700;font-size:12px;letter-spacing:.5px;padding:12px 22px;border-radius:10px;text-decoration:none;">
        Privacy Policy →
      </a>
    </div>
...
window.addEventListener('scroll', () => {
  let current = '';
  document.querySelectorAll('[id^="d"],[id^="r"]').forEach(sec => {

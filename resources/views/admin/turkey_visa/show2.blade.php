...
@section('title', 'Turkey Visit Visa — ' . $application->surname . ', ' . $application->first_name)
...
<style>
  :root {
    ...
    --gray-bg: #f4f6f9;
    --white: #ffffff;
    --shadow-sm: 0 2px 12px rgba(227,10,23,0.08);
  ...
  .av-breadcrumb a { color: var(--tr-red); text-decoration: none; font-weight: 600; }
  ...
  .btn-edit { background: var(--tr-red); color: #fff; border: 1.5px solid var(--tr-red); }
  .av-hero { background: linear-gradient(135deg, var(--tr-red-dark), var(--tr-red), #f04050); border-radius: 20px; padding: 36px 40px; display: flex; align-items: center; gap: 32px; margin-bottom: 28px; position: relative; overflow: hidden; }
  ...
  .av-hero::after { content: '☽  ★'; position: absolute; bottom: 14px; right: 28px; font-size: 18px; color: rgba(255,255,255,.2); letter-spacing: 8px; z-index: 1; }
  ...
  .av-card-icon { width: 40px; height: 40px; border-radius: 10px; background: var(--tr-red); display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
  .av-card-icon svg { color: #fff; }
  .av-card-title { font-family: var(--font-d); font-size: 18px; font-weight: 700; color: var(--tr-red-dark); }
  ...
  .sharecode-val { font-family: 'Courier New', monospace; font-size: 15px; font-weight: 700; background: linear-gradient(135deg,#fff0f0,#ffd6d6); color: var(--tr-red-dark); padding: 6px 14px; border-radius: 8px; border: 1.5px solid #fca5a5; display: inline-block; letter-spacing: 1px; }
  ...
  .doc-card:hover { border-color: var(--tr-red); box-shadow: 0 6px 24px rgba(227,10,23,.15); }
  ...
  .side-title { font-family: var(--font-d); font-size: 16px; font-weight: 600; color: var(--tr-red-dark); margin-bottom: 14px; }
...
<div class="av-wrap">
  ...
  <div class="av-topbar">
    <div class="av-breadcrumb">
      ...
      <span>/</span>
      <a href="{{ route('admin.visa.show.all') }}">Turkey Applications</a>
      <span>/</span>
    ...
    <div class="av-actions">
      ...
      <button class="btn-action btn-edit" onclick="window.location.href='{{ route('admin.turkey.visa.show', $application->id) }}'">
  ...
  <div class="av-hero">
    <div class="av-hero-flag">
      <img src="{{ asset('turkeyflag.svg') }}" alt="Turkey Flag"/>
    </div>
    <div class="av-hero-info">
      <p class="av-hero-sub">Turkey Visit Visa Application #{{ $application->id }}</p>
  ...
  <div class="av-grid">
    <div>
      ...
      <div class="av-card">
        <div class="av-card-header">
          ...
          <div><p class="av-card-title">Personal Information</p><p class="av-card-sub">Name, birth details, passport & contact</p></div>
        </div>
        <div class="av-card-body">
          ...
          <p style="font-family:var(--font-d);font-size:15px;font-weight:600;color:var(--tr-red-dark);margin-bottom:12px;">🛂 Passport Details</p>
          <div class="fv-grid fv-3">
          ...
          <hr class="fv-divider" style="margin:16px 0;">
          <p style="font-family:var(--font-d);font-size:15px;font-weight:600;color:var(--tr-red-dark);margin-bottom:12px;">📞 Contact Details</p>
          <div class="fv-grid fv-2">
            <div class="fv-item"><div class="fv-label">Mobile Phone</div><div class="fv-value"><a href="tel:{{ $application->mobile_phone }}" style="color:var(--tr-red);text-decoration:none;font-weight:600;">{{ $application->mobile_phone }}</a></div></div>
            <div class="fv-item"><div class="fv-label">Email Address</div><div class="fv-value"><a href="mailto:{{ $application->email }}" style="color:var(--tr-red);text-decoration:none;font-weight:600;">{{ $application->email }}</a></div></div>
          </div>
        </div>
      </div>
      ...
      <div class="av-card">
        <div class="av-card-header">
          ...
          <div><p class="av-card-title">Home Address</p><p class="av-card-sub">Current UK residential address</p></div>
        </div>
        <div class="av-card-body">
          <div class="fv-grid fv-2">
      ...
      <div class="av-card">
        <div class="av-card-header">
          ...
          <div><p class="av-card-title">Family Details</p><p class="av-card-sub">Parents' full names as required by the Turkish embassy</p></div>
        </div>
        <div class="av-card-body">
          <div class="fv-grid fv-2">
      ...
      <div class="av-card">
        <div class="av-card-header">
          ...
          <div><p class="av-card-title">Travel Details</p><p class="av-card-sub">Trip dates, destination cities & accommodation in Turkey</p></div>
        </div>
        <div class="av-card-body">
          <div class="fv-grid fv-2">
            <div class="fv-item">
            ...
            <div class="fv-item"><div class="fv-label">Cities to Visit in Turkey</div><div class="fv-value">🇹🇷 {{ $application->destination_city ?? '—' }}</div></div>
          ...
          <p style="font-family:var(--font-d);font-size:15px;font-weight:600;color:var(--tr-red-dark);margin-bottom:12px;">🏨 Accommodation in Turkey</p>
          <div class="fv-grid fv-2">
      ...
      <div class="av-card">
        <div class="av-card-header">
          ...
          <div><p class="av-card-title">UK Immigration Status</p><p class="av-card-sub">eVisa sharecode — required by the Turkish embassy</p></div>
        </div>
        <div class="av-card-body">
            ...
            <div class="fv-item">
              ...
              <div class="fv-value">
                @if($application->uk_sharecode)
                  ...
                  <a href="https://www.gov.uk/view-prove-immigration-status" target="_blank" style="margin-left:12px;font-size:11px;color:var(--tr-red);font-weight:600;text-decoration:none;">Verify on gov.uk →</a>
                @else
                  <span style="color:var(--gray-light);font-style:italic;font-size:13px;">Not provided</span>
                @endif
              </div>
            </div>
          </div>
          @if(!$application->uk_sharecode)
            <div class="info-box amber">⚠️ No sharecode submitted. The applicant may be a British citizen. Confirm before submitting to the Turkish embassy.</div>
          @endif
        </div>
      </div>
      ...
      <div class="av-card">
        ...
        <div class="av-card-body">
          <div style="background:var(--gray-bg);border-radius:10px;padding:18px 20px;font-size:13px;line-height:1.7;color:var(--gray-dark);white-space:pre-line;border-left:3px solid var(--tr-red);">{{ $application->message }}</div>
        </div>
      </div>
      @endif
    ...
    <div class="av-sidebar">
      ...
      <div class="side-card" style="background:linear-gradient(135deg,var(--tr-red-dark),var(--tr-red));border-color:transparent;">
        <p class="side-title" style="color:#fff;">Application Summary</p>
        <div class="side-row" style="border-color:rgba(255,255,255,.15)"><span class="side-row-label" style="color:rgba(255,255,255,.6)">Application ID</span><span class="side-row-val" style="color:#fff;font-family:'Courier New',monospace">#{{ $application->id }}</span></div>
        <div class="side-row" style="border-color:rgba(255,255,255,.15)"><span class="side-row-label" style="color:rgba(255,255,255,.6)">Submitted</span><span class="side-row-val" style="color:rgba(255,255,255,.85)">{{ $application->created_at->format('d M Y') }}</span></div>
        <div class="side-row" style="border-color:rgba(255,255,255,.15)"><span class="side-row-label" style="color:rgba(255,255,255,.6)">Cities</span><span class="side-row-val" style="color:rgba(255,255,255,.85)">{{ $application->destination_city ?? '—' }}</span></div>
        <div class="side-row" style="border-color:rgba(255,255,255,.15)"><span class="side-row-label" style="color:rgba(255,255,255,.6)">Purpose</span><span class="side-row-val" style="color:rgba(255,255,255,.85)">{{ $application->visit_purpose ?? '—' }}</span></div>
        <div class="side-row" style="border-color:rgba(255,255,255,.15)"><span class="side-row-label" style="color:rgba(255,255,255,.6)">Departure</span><span class="side-row-val" style="color:rgba(255,255,255,.85)">{{ $application->departure_date ? \Carbon\Carbon::parse($application->departure_date)->format('d M Y') : '—' }}</span></div>
        <div class="side-row" style="border-color:rgba(255,255,255,.15);border-bottom:none"><span class="side-row-label" style="color:rgba(255,255,255,.6)">Return</span><span class="side-row-val" style="color:rgba(255,255,255,.85)">{{ $application->return_date ? \Carbon\Carbon::parse($application->return_date)->format('d M Y') : '—' }}</span></div>
      </div>
      ...
      {{-- <div class="side-card">
        ...
        <div class="side-row">
          <span class="side-row-label"><span style="width:6px;height:6px;border-radius:50%;background:{{ $doc['required'] ? 'var(--red)' : 'var(--green)' }};display:inline-block;flex-shrink:0;"></span>{{ $doc['label'] }}</span>
          <span>
            @if($application->{$doc['key']})
        ...
        @endforeach
        <div class="side-row">
          <span class="side-row-label"><span style="width:6px;height:6px;border-radius:50%;background:var(--red);display:inline-block;flex-shrink:0;"></span>UK eVisa Sharecode</span>
          <span>
            @if($application->uk_sharecode)
      ...
      <div class="side-card">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          <a href="mailto:{{ $application->email }}" style="display:flex;align-items:center;gap:10px;padding:11px 14px;border-radius:10px;background:#fff5f5;border:1.5px solid rgba(227,10,23,.15);font-size:12px;font-weight:600;color:var(--tr-red);text-decoration:none;">

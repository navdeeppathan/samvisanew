...
<a href="{{ route('admin.turkey.visa.index') }}" class="btn btn-secondary mb-4">← Back</a>

<h2 class="mb-4">Turkey Visa Application Details</h2>

<form method="POST" action="{{ route('admin.turkey.application.send.correction', $application->id) }}">
@csrf

...
<style>
  ...
  *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
  ...
  .ph-slide:nth-child(1) {
    background-image: url('https://images.unsplash.com/photo-1549692520-acc6669e2f0c'); /* Great Wall */
    animation-delay: 0s;
  }
...
<div class="steps-wrap">
  ...
  <div class="step-pill active" onclick="goToStep(1)">
...
<div class="form-wrap">
  ...
  <div class="form-section" id="step-8">
    ...
    <div class="fs-body">
      ...
      <div class="form-nav">
        ...
        <button type="button" class="btn-next" onclick="nextStep(8)">Next Step →</button>
      </div>
    </div>
  </div>

  <!-- STEP 9: TRAVEL HISTORY -->
  <div class="form-section" id="step-9">
    <div class="fs-header">
    ...
    <div class="fs-body">
      ...
      <div class="form-nav">
        ...
        <button type="button" class="btn-next" onclick="nextStep(9)">Next Step →</button>
      </div>
    </div>
  </div>

  <!-- STEP 10: DECLARATIONS -->
  <div class="form-section" id="step-10">
    <div class="fs-header">
  ...
  <div class="sidebar">
    ...
    <div class="side-card">
      ...
      <div class="contact-item"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07"/></svg><a href="tel:+447879175585">+44 7879 175585</a></div>
      <div class="contact-item"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413z"/></svg><a href="https://wa.me/447879175585" target="_blank">WhatsApp Us</a></div>

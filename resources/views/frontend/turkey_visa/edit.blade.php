...
<head>
<meta charset="UTF-8">
<title>Update Turkey Visa</title>
...
<h2>Update Your Turkey Visa Application</h2>
...
<form method="POST" action="{{ route('turkey.application.update',$application->id) }}" enctype="multipart/form-data">
@csrf

...
<title>Turkey Visit Visa Application — SAM Visa Services</title>
...
/* PAGE HEADER */
/* .page-header{background:linear-gradient(135deg,#e30a17 0%,#b00d13 50%,#8a0a0f 100%);padding:56px 48px;text-align:center;position:relative;overflow:hidden;}
...
.ph-slide:nth-child(1) {
  background-image: url('https://images.unsplash.com/photo-1541432901042-2d8bd64b4a9b'); /* Istanbul Hagia Sophia */
  animation-delay: 0s;
}
.ph-slide:nth-child(2) {
  background-image: url('https://images.unsplash.com/photo-1507608616759-54f48f0af0ee'); /* Cappadocia balloons */
  animation-delay: 5s;
}
.ph-slide:nth-child(3) {
  background-image: url('https://images.unsplash.com/photo-1524230572899-a752b3835840'); /* Blue Mosque */
  animation-delay: 10s;
}
.ph-slide:nth-child(4) {
  background-image: url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e'); /* Turkish coast */
  animation-delay: 15s;
}
...
.page-header::after {
  ...
  position: absolute;
  inset: 0;
  background: linear-gradient(135deg, rgba(227,10,23,0.85), rgba(150,0,10,0.75));
  z-index: 1;
}
...
{{-- <div class="page-header">
  <div class="ph-inner">
    ...
    <h1 class="ph-title">Turkey <em>Visit Visa</em></h1>
...
<form id="visaForm" action="{{ route('visa.turkey.submit') }}" method="POST" enctype="multipart/form-data">
@csrf
  ...
  {{-- <div class="form-section" id="step-3"> --}}
    <div class="fs-header">
      ...
      <div>
        ...
        <p class="fs-sub">Your parents' full names as required by the Turkish embassy.</p>
      </div>
    </div>
    <div class="fs-body">

      <div class="info-box blue">
        <strong>ℹ️ Why are parents' names required?</strong> The Turkish embassy requires both parents' full names as part of the visit visa application to verify your identity and family background.
      </div>
  ...
  {{-- <div class="form-section" id="step-4"> --}}
    <div class="fs-header">
      ...
      <div>
        ...
        <p class="fs-sub">Your planned Turkey trip dates and accommodation.</p>
      </div>
    </div>
    <div class="fs-body">
      ...
      <div class="fg fg-2">
        <div class="fl"><label class="lbl">Cities to Visit in Turkey <span class="req">*</span></label><input type="text" name="destination_city" class="fi" placeholder="e.g. Istanbul, Antalya, Cappadocia" required/></div>
        <div class="fl">
  ...
  {{-- <div class="form-section" id="step-5"> --}}
    <div class="fs-header">
      ...
      <div>
        ...
        <p class="fs-sub">Three mandatory documents are required for the Turkey visa application.</p>
      </div>
    </div>
    <div class="fs-body">

      <div class="info-box red">
        <strong>🔴 All three documents below are mandatory for Turkey.</strong> Your application cannot be submitted without attaching your passport scan, passport size photo, and UK visa copy.
      </div>
      ...
      <div class="fl" style="margin-bottom:20px;">
        ...
        <div class="file-zone" onclick="triggerFile('uk_visa_copy')">
          ...
          <p class="fz-sub">JPEG or PDF · <em>Mandatory — required by Turkish embassy</em></p>
        </div>
        <div id="prev-ukv"></div>
      </div>
...
<div class="form-section" id="step-4">
  ...
  {{-- <div class="form-section" id="step-6"> --}}
    <div class="fs-header">
      ...
      <div>
        ...
        <p class="fs-sub">Your UK eVisa sharecode — required by the Turkish embassy.</p>
      </div>
    </div>
    <div class="fs-body">

      <div class="info-box blue">
        <strong>🇬🇧 UK eVisa Sharecode:</strong> The Turkish embassy requires proof of your UK immigration status. Your sharecode allows them to verify your leave to remain or eVisa online. It always <strong>starts with the letter S</strong>.<br/><br/>
  ...
  {{-- <div class="form-section" id="step-7"> --}}
    <div class="fs-header">
      ...
      <div>
        ...
        <p class="fs-sub">Review and confirm before submitting your Turkey visa application.</p>
      </div>
    </div>
    <div class="fs-body">
  ...
  <div class="sidebar">
    ...
    <div class="side-card">
      <p class="side-title">⚠️ Turkey Requirements</p>
      <ul class="req-list">
        <li><span style="font-size:16px">🛂</span><span>Passport scan + passport photo + UK visa are all <strong>mandatory</strong></span></li>
        <li><span style="font-size:16px">👨‍👩‍👦</span><span>Both parents' full names required by Turkish embassy</span></li>
    ...
    <div class="side-card">
      ...
      <a href="visa-turkey.html" class="country-link current">🇹🇷 Turkey — Current</a>

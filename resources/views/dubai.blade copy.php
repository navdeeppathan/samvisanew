...
<title>UAE / Dubai Visit Visa Application — SAM Visa Services</title>
...
<style>
  ...
  *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
  ...
  /* PAGE HEADER */
  /* .page-header{background:linear-gradient(135deg,#006233 0%,#004d27 40%,#c41e3a 100%);padding:56px 48px;text-align:center;position:relative;overflow:hidden;}
  ...
  .ph-slide:nth-child(1) {
    background-image: url('https://images.unsplash.com/photo-1518684079-3c830dcef090'); /* Burj Khalifa */
    animation-delay: 0s;
  }
  .ph-slide:nth-child(2) {
    background-image: url('https://images.unsplash.com/photo-1508057198894-247b23fe5ade'); /* Dubai skyline */
    animation-delay: 5s;
  }
  .ph-slide:nth-child(3) {
    background-image: url('https://images.unsplash.com/photo-1500530855697-b586d89ba3ee'); /* Desert safari */
    animation-delay: 10s;
  }
  .ph-slide:nth-child(4) {
    background-image: url('https://images.unsplash.com/photo-1498050108023-c5249f4df085'); /* Business travel */
    animation-delay: 15s;
  }
  ...
  /* UAE STYLE OVERLAY (green + red tone) */
  .page-header::after {
    content: "";
    position: absolute;
    inset: 0;
    background: linear-gradient(135deg, rgba(0,98,51,0.85), rgba(0,77,39,0.75), rgba(196,30,58,0.6));
    z-index: 1;
  }

  /* DOT PATTERN (keep your original) */
  .page-header::before {
    content: '';
    position: absolute;
    inset: 0;
...
{{-- <div class="page-header">
  <div class="ph-inner">
    ...
    <h1 class="ph-title">UAE / Dubai <em>Visit Visa</em></h1>
...
<div class="page-header">
  ...
  <div class="ph-inner">
    ...
    <p class="ph-country">Visit Visa Application</p>
    <h1 class="ph-title">UAE / Dubai</h1>
    <p class="ph-sub">
...
<form id="visaForm" action="{{ route('visa.dubai.submit') }}" method="POST" enctype="multipart/form-data">
@csrf
<input type="hidden" name="country" value="UAE / Dubai"/>
...
<div class="form-wrap">
  ...
  <div class="form-section" id="step-3">
    <div class="fs-header">
      ...
      <div>
        ...
        <p class="fs-sub">Your parents' full names as required by the UAE embassy.</p>
      </div>
    </div>
    <div class="fs-body">

      <div class="info-box blue">
        <strong>ℹ️ Why are parents' names required?</strong> The UAE embassy requires both parents' full names as part of the visit visa application to verify your identity and family background.
      </div>
  ...
  <div class="form-section" id="step-4">
    <div class="fs-header">
      ...
      <div>
        ...
        <p class="fs-sub">Your planned UAE / Dubai trip dates and accommodation.</p>
      </div>
    </div>
    <div class="fs-body">
      ...
      <div class="fg fg-2">
        <div class="fl"><label class="lbl">Cities to Visit in UAE / Dubai <span class="req">*</span></label><input type="text" name="destination_city" class="fi" placeholder="e.g. Dubai, Abu Dhabi, Sharjah" required/></div>
        <div class="fl">
      ...
      <div class="fg fg-1">
        <div class="fl"><label class="lbl">Accommodation / Host Address in UAE / Dubai <span class="req">*</span></label><input type="text" name="accommodation" class="fi" placeholder="Hotel name or host's full address in UAE / Dubai" required/></div>
      </div>
  ...
  <div class="form-section" id="step-5">
    <div class="fs-header">
      ...
      <div>
        ...
        <p class="fs-sub">Three mandatory documents are required for the UAE / Dubai visa application.</p>
      </div>
    </div>
    <div class="fs-body">

      <div class="info-box red">
        <strong>🔴 All three documents below are mandatory for UAE / Dubai.</strong> Your application cannot be submitted without attaching your passport scan, passport size photo, and UK visa copy.
      </div>
  ...
  <div class="form-section" id="step-6">
    <div class="fs-header">
      ...
      <div>
        ...
        <p class="fs-sub">Your UK eVisa sharecode — required by the UAE embassy.</p>
      </div>
    </div>
    <div class="fs-body">

      <div class="info-box blue">
        <strong>🇬🇧 UK eVisa Sharecode:</strong> The UAE embassy requires proof of your UK immigration status. Your sharecode allows them to verify your leave to remain or eVisa online. It always <strong>starts with the letter S</strong>.<br/><br/>
  ...
  <div class="form-section" id="step-7">
    <div class="fs-header">
      ...
      <div>
        ...
        <p class="fs-sub">Review and confirm before submitting your UAE / Dubai visa application.</p>
      </div>
    </div>
    <div class="fs-body">
  ...
  <div class="sidebar">
    ...
    <div class="side-card">
      <p class="side-title">⚠️ UAE / Dubai Requirements</p>
      <ul class="req-list">
        <li><span style="font-size:16px">🛂</span><span>Passport scan + passport photo + UK visa are all <strong>mandatory</strong></span></li>
        <li><span style="font-size:16px">👨‍👩‍👦</span><span>Both parents' full names required by UAE embassy</span></li>
    ...
    <div class="side-card">
      ...
      <div class="contact-item">
        ...
        <a href="https://wa.me/447879175585" target="_blank" rel="noopener">WhatsApp Us</a>
      </div>
      <div class="contact-item">

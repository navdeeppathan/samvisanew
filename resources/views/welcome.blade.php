...
<nav id="navbar">
  <div class="nav-inner">
    ...
    <ul class="nav-links">
      ...
      <li><a href="tel:+447912649410" class="nav-phone">
  ...
  <div class="foot-in">
    <div class="foot-grid">
      ...
      <div class="foot-col reveal reveal-d3"><h4>Quick Links</h4><ul>
        ...
        <li><a href="#testimonials">Reviews</a></li>
        <li><a href="https://wa.me/447912649410">WhatsApp</a></li>
